...
function WomenPostsPage ({ blogPosts }) {

  const navigate=useNavigate();

  return (
    <div className='mt-10 mb-20 px-10'>
      <h1 className='contact flex items-center justify-center bg-gradient-to-r from-blue-500 to-purple-600 text-transparent bg-clip-text'>ADHD-women Posts</h1>
