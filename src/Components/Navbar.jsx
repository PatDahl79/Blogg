...
export default function Nav() {
  ...
  const { mode, toggleMode, isAuthenticated } = context;
      ...
      >
        ...
        <div className="flex items-center justify-between text-blue-gray-900">
          ...
          <div className="flex items-center gap-4">
            ...
            {/* Search Icon */}
            <div className="mr-4 cursor-pointer py-1.5 text-xl font-bold flex gap-2 items-center">
              <SearchDialog />
            </div>
            {/* Share Icon */}
            <div className="mr-4 cursor-pointer py-1.5 text-xl font-bold flex gap-2 items-center hidden lg:block">
              <ShareDialogBox />
            </div>
